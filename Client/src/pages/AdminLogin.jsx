        ...
        <div style={{ alignContent: "center", padding: "8%" }}>
          ...
          <form onSubmit={handleLogin}>
            ...
            <div className="input-wrapper">
              ...
              <input className="form-input" type={showPassword ? "text" : "password"} placeholder="Enter Admin Password" value={password} onChange={(e) => setPassword(e.target.value)} required />
              <button
                type="button"
