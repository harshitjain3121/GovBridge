        ...
        <div style={{ alignContent: "center", padding: "8%" }}>
          ...
          <form onSubmit={handleRegister}>
            ...
            <div className="input-wrapper">
              ...
              <input className="form-input" type={showPassword ? "text" : "password"} placeholder="Create Password" value={password} onChange={(e) => setPassword(e.target.value)} required />
              <button
                type="button"
            ...
            <div className="input-wrapper">
              ...
              <input className="form-input" type={showConfirmPassword ? "text" : "password"} placeholder="Confirm Password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} required />
              <button
                type="button"
            ...
            <div style={{ marginTop: "3%", textAlign: "center", fontWeight: "bold", fontSize: "large" }}>
              <span ><a href="/login" style={{ textDecoration: "none", color: "#2563eb" }}>Citizen Login</a></span>
            </div>
          </form>
        </div>
